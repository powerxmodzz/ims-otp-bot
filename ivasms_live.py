...
@sio.event
def connect():
    log.info("✅ Socket.IO connected! Waiting for ALL events...")
...
log.info("="*55)
log.info("  EVENT LOGGER — Sab events print honge")
log.info("  Jab live SMS aaye tab screenshot lo!")
log.info("="*55)
