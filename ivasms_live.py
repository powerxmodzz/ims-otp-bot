...
def parse_live_page(html):
    ...
    for tr in rows:
        ...
        # Find number: longest numeric string 8-15 digits
        number  = None
        country = ""
        service = ""
        message = ""
        ...
        if number and message and len(message) > 3:
            ...
            log.debug(f"  Found: +{number} | {service} | {message[:40]}")
